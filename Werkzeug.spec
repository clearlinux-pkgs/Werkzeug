...
Version  : 0.12
Release  : 33
URL      : http://pypi.debian.net/Werkzeug/Werkzeug-0.12.tar.gz
Source0  : http://pypi.debian.net/Werkzeug/Werkzeug-0.12.tar.gz
...
%prep
%setup -q -n Werkzeug-0.12

%build
export LANG=C
export SOURCE_DATE_EPOCH=1489255541
